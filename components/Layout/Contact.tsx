      ...
      <div className="relative z-10 w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8 text-center lg:text-left">
          ...
          <p className="text-xl font-bold max-w-md mx-auto lg:mx-0 border-l-4 border-foreground pl-6 py-2 bg-card-surface/50 backdrop-blur-sm shadow-neo-4">
            Got a project in mind or just want to say hi? Drop us a message and
        ...
        <div className="relative group">
          ...
          <div className="relative bg-card-surface border-3 border-foreground p-8 md:p-10 shadow-neo-lg rounded-xl flex flex-col gap-6">
            ...
            <Button className="w-full h-14 text-lg font-black uppercase tracking-wider border-2 border-foreground shadow-neo-4 hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-neo-sm bg-[#11A365] text-white hover:bg-[#0e8a55] transition-all mt-2">
