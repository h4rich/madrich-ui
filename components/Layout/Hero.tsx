...
const Hero = () => {
  return (
    <>
      <div className="relative font-grotesk border-dashed border-x-2 border-black flex justify-between h-screen w-full max-w-[1640px] mx-auto mask-b-from-90% overflow-hidden">
        {/* Left Section */}
        <div className="flex max-h-screen flex-col mt-24 mb-16 lg:mb-0 lg:mt-0 mx-4 lg:mx-12 justify-between w-full lg:w-[50%] ">
          ...
          {/* Bottom Left Avatars */}
          <div className="flex flex-row justify-between items-center mr-4 lg:mr-16 sm:mt-16 mt-0">
            <div className="">
              <CreatorCard />
            </div>
