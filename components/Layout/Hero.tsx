      ...
      <div className="relative font-grotesk flex justify-between h-screen w-full mask-b-from-90% overflow-hidden">
        <div className="flex flex-col gap-3 pl-20 justify-between w-[60%]">
          <div className="flex flex-col gap-4 mt-40 ">
            ...
            <div className=" mt-5">
              <button className="border border-foreground p-2 px-4 font-semibold bg-hero shadow-neo ">
        ...
        <div className="w-[40%] flex flex-col gap-6">
          <div className="flex gap-5 justify-between">
            <div className="flex mt-20 h-10 gap-5">
              <button className="border border-foreground p-1 px-5 font-semibold bg-[#FFC900] rounded-sm shadow-neo ">
                Badge
              </button>
              <button className="border border-foreground p-1 px-5 font-semibold bg-[#11A365] rounded-lg shadow-neo ">
                Badge
              </button>
              <button className="border border-foreground p-1 px-5 font-semibold bg-[#FF7051] rounded-full shadow-neo ">
                Badge
              </button>
            </div>
          ...
          <div className="flex justify-between">
            <Button className="w-[220px] rounded-sm h-11 text-lg">
              Button CTA
            </Button>
            <Button className="w-[220px] rounded-sm h-11 bg-background text-lg">
              Button CTA
            </Button>
            <Button className="w-[220px] rounded-sm h-11 bg-[#11A365] text-foreground border-r-0 rounded-r-none text-lg">
              Button CTA
            </Button>
          </div>
