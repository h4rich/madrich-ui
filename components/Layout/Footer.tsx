      ...
      <div className="max-w-[1400px] mx-auto px-6 py-16 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-end gap-12 md:gap-24">
          ...
          <div className="flex flex-col gap-6">
            <h3 className="text-2xl font-black uppercase border-b-4 border-foreground pb-2 inline-block w-fit">Explore</h3>
          ...
          <div className="flex flex-col gap-6">
            <h3 className="text-2xl font-black uppercase border-b-4 border-foreground pb-2 inline-block w-fit">Socials</h3>
            <div className="flex gap-4">
              <Link href="#" className="bg-white p-3 border-2 border-foreground shadow-[4px_4px_0px_0px_#000] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_#000] transition-all">
