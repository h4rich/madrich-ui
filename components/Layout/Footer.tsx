...
const Footer = () => {
  return (
    <footer className="w-full font-grotesk border-t-4 border-border-strong bg-background relative overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 py-16 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-end gap-12 md:gap-24">
          <div className="flex flex-col gap-6">
            <h3 className="text-2xl font-black uppercase border-b-4 border-border-strong pb-2 inline-block w-fit">
              Links
            </h3>
